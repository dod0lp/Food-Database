-- master database for credentials etc
USE [master];
GO

-- Admin variables - credentials
-- (based on .env file)
...
-- adding users
-- with simple condition to ao avoid duplicates
-- DB_NAME - name of the database (food database)
...
-- DB_USER - name of the user that will be accesing this (Food) database
